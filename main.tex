...
% --- LOGO ---
\pgfdeclareimage[height=1cm]{fami-logo}{Logo}
...
\title[Phân tích số liệu]{Chủ đề 7: Hồi quy tuyến tính } 
\author[Nhóm 7] {Nhóm 7}
\institution[FAMI-HUST]{Khoa Toán-Tin, ĐHBK Hà Nội}
...
%\input{chuong1/chuong1.tex}
\input{chuong2/chuong2.tex}
\input{chuong3/chuong3.tex}
\input{chuong4/chuong4.tex}
\input{chuong5/chuong5.tex}
