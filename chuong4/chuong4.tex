%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ĐÂY LÀ NỘI DUNG CHO FILE chuong4/chuong4.tex
% Nội dung được bóc tách từ file bạn gửi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
% \includegraphics[width=0.35\linewidth, keepaspectratio]{ellipse-example.png}
% Ghi chú: File ellipse-example.png cần được đặt trong thư mục images/
\includegraphics[width=0.35\linewidth, keepaspectratio]{images/ellipse-example.png}
\end{center}
\end{frame}